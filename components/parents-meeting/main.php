	...
	if($_GET['urlvar2'] == 'teacher') {
		...
		<div class="row">
			<div class="span12">
				<div class="hero-unit">
					<h1>Welcome</h1>
					<p><strong>This is the new online booking system for Parents Meeting.</strong></p>
						<?php
						if($userInfo['staff'] == 1)
						{
							?>
							<a href="/parents-meeting/teacher/" class="btn btn-info btn-large pull-right">Manage Your Meeting</a>
							<?php
						} else {
							if($userInfo['year'] == $parentsMeetingCurrentYear)
							{
								?>
